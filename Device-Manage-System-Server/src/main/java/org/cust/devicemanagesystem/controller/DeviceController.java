...
public class DeviceController {
  ...
  public List<String> deviceNameList(@PathVariable String searchName) {
    ...
    return deviceService.list(Wrappers.lambdaQuery(new Device()).like(Device::getName, searchName))
        .stream()
        .map(Device::getName)
        .distinct()
        .collect(Collectors.toList());
  ...
  public IPage<DeviceVo> searchDevices(
      @NotNull @RequestBody Page<DeviceVo> page,
