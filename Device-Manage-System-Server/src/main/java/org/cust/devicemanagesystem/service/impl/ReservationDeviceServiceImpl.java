 ...
 */
@Service
public class ReservationDeviceServiceImpl
    extends ServiceImpl<ReservationDeviceMapper, ReservationDevice>
    implements IReservationDeviceService {

  private final ReservationDeviceMapper reservationDeviceMapper;

  @Override
  public IPage<ReservationDeviceVo> queryReservationPage(
